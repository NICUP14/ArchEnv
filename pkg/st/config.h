 ...
 */
static char *font = "Fixedsys Excelsior:style=Regular:size=23:antialias=true:autohint=true";
...
static Shortcut shortcuts[] = {
	...
	{ ControlMask|ShiftMask, XK_space,       keyboard_select, { 0 } },
	{ ControlMask,           XK_slash,       searchforward,   { 0 } },
	{ ControlMask,           XK_question,    searchbackward,  { 0 } },
	// { ShiftMask,             XK_Num_Lock,    numlock,         {.i =  0} },
	// { ShiftMask,             XK_Y,           clippaste,       {.i =  0} },
	// { ShiftMask,             XK_Insert,      clippaste,       {.i =  0} },
	// { ControlMask,           XK_Home,        zoomreset,       {.f =  0} },
	// { ShiftMask,             XK_O,           changealpha,     {.f = +0.05} },
	// { ShiftMask,             XK_P,           changealpha,     {.f = -0.05} },
